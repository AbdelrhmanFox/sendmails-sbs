...
const HANDLERS = {
  ...
  'trainee-login': require('../netlify/functions/trainee-login').handler,
  'trainee-change-password': require('../netlify/functions/trainee-change-password').handler,
  'trainee-me': require('../netlify/functions/trainee-me').handler,
  'trainee-courses': require('../netlify/functions/trainee-courses').handler,
  'trainee-classroom': require('../netlify/functions/trainee-classroom').handler,
  'trainee-submissions': require('../netlify/functions/trainee-submissions').handler,
  'trainee-submission-upload': require('../netlify/functions/trainee-submission-upload').handler,
  'trainee-admin-reset': require('../netlify/functions/trainee-admin-reset').handler,
